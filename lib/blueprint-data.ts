...
export const sihFloors: BlueprintNote[] = [
  {
    ...
    images: [
      { src: "/images/BenhVienSIH1.svg", alt: "Sảnh chính tầng trệt SIH" },
      { src: "/images/BenhVienSIH2.svg", alt: "Khu vực tiếp đón" },
      { src: "/images/BenhVienSIH3.svg", alt: "Mặt bằng bố trí tầng trệt" },
      { src: "/images/BenhVienSIH4.svg", alt: "Phân khu chức năng" },
      { src: "/images/BenhVienSIH5.svg", alt: "Sơ đồ lối thoát hiểm" },
      { src: "/images/BenhVienSIH6.svg",},
    ],
  ...
  },
  {
    ...
    images: [
      { src: "/images/Lau1.svg", alt: "Khoa khám bệnh lầu 1" },
      { src: "/images/Lau2.svg", alt: "Khu vực chờ khám" },
      { src: "/images/Lau3.svg", alt: "Mặt bằng khoa khám bệnh" },
    ],
  ...
  },
  {
    ...
    images: [
      { src: "/images/1.svg", alt: "Hành lang khoa lưu trú" },
      { src: "/images/2.svg", alt: "Phòng bệnh tiêu chuẩn" },
      { src: "/images/3.svg", alt: "Mặt bằng khoa lưu trú" },
      { src: "/images/4.svg", alt: "Phân khu phòng bệnh" },
      { src: "/images/5.svg", alt: "Lối thoát hiểm khoa lưu trú" },
      { src: "/images/6.svg",},
    ],
